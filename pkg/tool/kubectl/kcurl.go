...
Example: 
  ./k8strike tool kcurl default get 'https://192.168.0.234:6443/api/v1/nodes'
  ./k8strike tool kcurl /var/run/secrets/kubernetes.io/serviceaccount/token get 'https://192.168.0.234:6443/api/v1/nodes'
  ./k8strike tool kcurl anonymous post 'https://192.168.0.234:6443/api/v1/nodes' '{"apiVersion":"v1",...}'
`
